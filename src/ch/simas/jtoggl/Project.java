...
public class Project {
    ...
    public Project(String jsonString) {
        ...
        this.colour = (String) object.get("color");
    ...
    public String toString() {
        return "Project{" + "id=" + id + ", name=" + name + ", active=" + active + ", is_private=" + is_private + ", template=" + template + ", billable=" + billable + ", cid=" + cid + ", workspace=" + workspace + ", colour = " + colour + '}';
    }
